...
#  moves the player ships
    def player_move(self):
        global first_ship,second_ship,shoot,border2,border1,ship_speed#imports global variable for use
...
#  no comment
    def enmey_shoot(self):
        global charged,ship_height,ship_speed,ship_width,recharge_time,huge_laser,charge_sound
        ...
        if keyy[pygame.K_ESCAPE]:
            ...
            if choose_ship:
                ...
                for settng in self.setting.sprites():
                    settng.kill()
                self.setting.add(Enmey((screen_width/2)-50,400,False,ship_option,30,30))
    def draw(self):
        global count
        if help:
            ...
            if count!=0:
               screen.blit(font.render('retry',True,(0,255,0)),(screen_width/2,250)) 
